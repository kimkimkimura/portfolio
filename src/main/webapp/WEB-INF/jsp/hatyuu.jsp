...
<form><br>
	...
	<input type="text" name="z10001" placeholder="配合・トッピング連動"><br>
	<label for="z10002">塩:　　　　　　　　</label>
	<input type="text" name="z10002" placeholder="配合・トッピング連動">
	</div><br>
	
	業者：乳業
	<div><label for="z20001">ナチュラルチーズ:　</label>
	<input type="text" name="z20001" placeholder="配合・トッピング連動"><br>
	...
	<input type="text" name="z30001" placeholder="配合・トッピング連動"><br>
	...
	<input type="text" name="z50001" placeholder="配合・トッピング連動"><br>
	<label for="z50002">ドライイースト:　　</label>
	<input type="text" name="z50002" placeholder="配合・トッピング連動"><br>
	<label for="z50003">はちみつ:　　　　　</label>
	<input type="text" name="z50003" placeholder="配合・トッピング連動"><br>
	<label for="z50004">マスタード:　　　　</label>
	<input type="text" name="z50004" placeholder="配合・トッピング連動"><br>
	<label for="z50005">ブラックペッパー:　</label>
	<input type="text" name="z50005" placeholder="配合・トッピング連動"><br>
	<label for="z50006">レーズン:　　　　　</label>
	<input type="text" name="z50006" placeholder="配合・トッピング連動"><br>
